<template>
  ...
  <b-modal size='lg' v-model='modalShow' id='modal-info'
          ...
          <b-col md='8'>
            ...
            <div v-if='restaurant.photos'>
              ...
              <b-button-group size='sm'>
                <b-button v-if='restaurant.photos.xsmall'
                  variant='danger' :href='restaurant.photos.xsmall.url' target='_blank'>X-Small</b-button>
                <b-button v-if='restaurant.photos.small'
                  variant='warning' :href='restaurant.photos.small.url' target='_blank'>Small</b-button>
                <b-button v-if='restaurant.photos.legacy'
                  variant='info' :href='restaurant.photos.legacy.url' target='_blank'>Legacy</b-button>
              </b-button-group>
            </div>
          </b-col>
        </b-row>
      ...
      <b-tab title='Features'>
        <b-row>
          ...
          <b-col cols='sm-7'>
            ...
            <h6>Dining style</h6>
            <div>
              <span class='badge mx-1' :class='`bg-${tagColor(index)}`'
                v-for='(style, index) in restaurant.diningStyles'
                :key='`style-${index}`'>{{ style }}</span>
            </div>
          </b-col>
        </b-row>
      </b-tab>
